...
public class Space {
    ...
    public void moveAllItems() {
        ...
        getAllItems().stream().forEach(BaseObject::move);
    }
    ...
    public List<BaseObject> getAllItems() {
        ...
        objects.addAll(Space.game.getRockets());
        objects.addAll(Space.game.getBombs());
        objects.addAll(Space.game.getUfos());
        objects.add(ship);
        return objects;
    }
    ...
    public void removeDead() {
        ...
        bombs.removeIf(el -> !el.isAlive());
        rockets.removeIf(el -> !el.isAlive());
        ufos.removeIf(el -> !el.isAlive());
    }
